                ...
                <div class="table-responsive">
                    <div class="tabbable">
                        <ul id="myTab" class="nav nav-tabs">
                            ...
                            <?php }?>
                            <li>
                                <a href="<?php echo Yii::app()->createUrl('/scratch/scratch/create',array('type'=>$type))?>" class="btn btn-primary">添加</a>
                            </li>
                        </ul>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample-table-1">
                                        ...
                                        <?php $page = Yii::app()->request->getParam('page',1);$i=($page-1)*Page::SIZE;foreach($data as $d){$i++;?>
                                            <tr>
                                                ...
                                                <?php if($type==GiftModel::TYPE_KEYWORDS){?>
                                                <td>
                                                        <?php foreach($d->scratch_keywords as $isAccurate){if($isAccurate->isAccurate){?>
                                                ...
                                                <td style="width:23%">
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <?php if($d->ispaward){?>
                                                        <a class="btn btn-xs btn-primary" href="<?php echo Yii::app()->createUrl('scratch/scratch/codes/id/'.$d->id)?>">
