<div class="row">
    <div class="col-xs-12">
        ...
        <div class="space-4"></div>
        <div class="form-group">
            <?php echo $form->labelEx($model, 'isCode', array('class' => BootStrapUI::formLabelClass)); ?>
            <div class="col-sm-4">
                <?php echo $form->checkBox($model, 'isCode', array('class' => 'col-xs-2 col-sm-2')); ?>
                <?php echo $form->error($model, 'isCode', array('class' => 'help-block col-xs-12 col-sm-reset inline')); ?>
            </div>
        </div>
        <div class="space-4"></div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-3">
                ...
                <div  class="form-group">
                    签到:
                    <?php echo CHtml::textField('mun2')?>天
                    奖励:
                ...
                <div class="form-group">
                    签到:
                    <?php echo CHtml::textField('mun3')?>天
                    奖励:
    ...
    $().ready(function () {
        ...
        $("#submit").click(function () {
            if(result==false){
                ...
                result = keywordsCheck(wechatId, type, url, 'ScratchModel', responseId);
            }
            return result
        })
    });
