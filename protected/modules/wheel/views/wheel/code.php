                    ...
                    <div class="tabbable">
                        <ul id="myTab" class="nav nav-tabs">
                            <li class="<?php if($type==Globals::CODE_TYPE_LEGAL){?>active<?php }?>">
                                <a href="<?php echo Yii::app()->createUrl('wheel/wheel/codes/id/'.$scratchId,array('type'=>Globals::CODE_TYPE_LEGAL))?>">
                                    正版礼品码
                                </a>
                            </li>
                            <li class="<?php if($type==Globals::CODE_TYPE_UNLEGAL){?>active<?php }?>">
                                <a href="<?php echo Yii::app()->createUrl('wheel/wheel/codes/id/'.$scratchId,array('type'=>Globals::CODE_TYPE_UNLEGAL))?>">
                                    越狱版礼品码
                                </a>
                            </li>
                            <li>
