                    ...
                    <tr>
                        ...
                        <td style="width:12%">
                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                ...
                                <a class="btn btn-xs btn-danger  bootbox-confirm" rel="<?= Yii::app()->createUrl('manager/KeyWordsDelete/id/'.$d->id,array('type'=>ImagetextreplayModel::IMAGE_TEXT_REPLAY_TYPE)) ?>">
